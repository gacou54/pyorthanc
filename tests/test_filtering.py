...
@pytest.mark.parametrize('client_fixture, patient_filter, study_filter, series_filter, instance_filter, expected_nbr_of_patient, expected_nbr_of_series', [
...
def test_find(client_fixture, patient_filter, study_filter, series_filter, instance_filter, expected_nbr_of_patient, expected_nbr_of_series, request):
